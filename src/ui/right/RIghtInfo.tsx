...
export function RightInfo() {
    ...
    return <>
        <div className=" fixed right-0 top-0 flex flex-col items-end gap-2">
            ...
            <div title="fertilizer" className=" bg-[#ce9354] rounded-lg border-2 border-[#6c4d2b] hover:border-[#ffd5a9]  px-2 py-1 mt-4 flex items-center gap-1 select-none">
                <img className="w-6 h-6" src="/images/ui/fertilizer.svg" alt="fertilizer" />
                <span>{getClaimed()}</span>
            </div>
            <div title="fertilizer" className=" bg-[#ce9354] rounded-lg border-2 border-[#6c4d2b] hover:border-[#ffd5a9]  px-2 py-1 mt-4 flex items-center gap-1 select-none">
                <img className="w-6 h-6" src="/images/ui/fruits.svg" alt="fertilizer" />
